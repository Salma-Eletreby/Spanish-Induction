...
async function render() {
  if (state.lvlIndex == 1) {
    ...
    Click the sound icon to hear the word. 
    <br>
    Click on the card to see the English translation. 
`;
    ...
    document.getElementById("main-section").innerHTML = `
            ...
            <div id="card"onclick="toggleCard(this)">
                ...
                <div class="card__content">
                    ...
                    <p class="card__title">Classroom</p>
                </div>
        </div>
        `;
    ...
    document.getElementById("main-section").innerHTML = `
    <h1 id="lvl-title">Choose the correct word that describes the image</h1>
    <div id="question1">
        <div class="vocab-img">
            <img src="https://img.freepik.com/free-photo/view-modern-classroom-school_23-2150911443.jpg?ga=GA1.1.1425892491.1713816127&semt=ais_hybrid" alt="Classroom">
        </div>
        <div>
            <input type="radio" id="choice0" name="choice" value="Libro">
            <label for="choice0">Libro</label>
            <br>
            <input type="radio" id="choice1" name="choice" value="Pizarra">
            <label for="choice1">Pizarra</label>
            <br>
            <input type="radio" id="choice2" name="choice" value="Aula">
            <label for="choice2">Aula</label>
        </div>
    </div>
`;
    ...
    <div id="vocab">
        ...
        <tr>
            <td><img src="https://img.freepik.com/free-vector/school-building-educational-institution-college_107791-1051.jpg?ga=GA1.1.1425892491.1713816127&semt=ais_hybrid" alt="school"></td>
            <td>Escuela</td>
            <td>School</td>
            <td>
                <audio controls>
        ...
        <tr>
            <td><img src="https://img.freepik.com/free-photo/front-view-male-student-wearing-black-backpack-holding-copybooks-files-blue-wall_140725-42636.jpg?ga=GA1.1.1425892491.1713816127&semt=ais_hybrid" alt="student"></td>
            <td>Estudiante</td>
            <td>Student</td>
            <td>
                <audio controls>
                    <source src="https://www.dropbox.com/scl/fi/3c9vu3ud72qbg2ads30qi/student.mp3?rlkey=q92dhjph1ycw72xp6h1l0czkm&st=5k80xy53&dl=1" type="audio/mpeg">
                    Your browser does not support the audio element.
                </audio>
            </td>
        </tr>
...
<div id="vocab">
  <table id="vocab-table">
    ...
    <tr>
      <td><img src="https://img.freepik.com/free-vector/hand-drawn-flat-design-stack-books-illustration_23-2149341898.jpg?ga=GA1.1.1425892491.1713816127&semt=ais_hybrid" alt="book" /></td>
      <td>Libro</td>
      <td>Book</td>
      <td>
        <audio controls>
          <source src="https://www.dropbox.com/scl/fi/scpriiiebdfvsunsru0mi/book.mp3?rlkey=pa0pn04lhr1dctx6n1y4pop2i&st=t6ouqmr8&dl=1" type="audio/mpeg" />
          Your browser does not support the audio element.
        </audio>
      </td>
    </tr>
  ...
  <div></div>
    ...
    document.getElementById("start-btn").style.width = "25%;";
    document.getElementById("main-section").innerHTML = `
        <h1 id="lvl-title">Please drag the correct word to appropriate place</h1>
          <div class="label-picture">
                <div class="labels-to-sort">
                    <div id="word-0" class="label-dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);"  style="background-color:#B5CFB7">
                        <div id="draggable-0" class="draggable-label" draggable="true" ondragstart="onDragStart(event);">Profesora</div>
                    </div>
                    <div id="word-1" class="label-dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);"  style="background-color:#B5CFB7">
                        <div id="draggable-1" class="draggable-label" draggable="true" ondragstart="onDragStart(event);">Estudiante</div>
                    </div>
                    <div id="word-2" class="label-dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);"  style="background-color:#B5CFB7">
                        <div id="draggable-2" class="draggable-label" draggable="true" ondragstart="onDragStart(event);">Libro</div>
                    </div>
                    <div id="word-3" class="label-dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);"  style="background-color:#B5CFB7">
                        <div id="draggable-" class="draggable-label" draggable="true" ondragstart="onDragStart(event);">Pizarra</div>
                    </div>
                </div>
...
`;
    ...
    document.getElementById("main-section").innerHTML = `
            ...
            <div id="card"onclick="toggleCard(this)">
                ...
                <audio controls>
                    <source src="https://www.dropbox.com/scl/fi/dxb5z972j3d98fuylecjz/sentence.mp3?rlkey=i3wa3sbbsde19o9wazxvgulgk&st=fkj6pd0j&dl=1" type="audio/mpeg">
                    Your browser does not support the audio element.
                </audio>
                <p class="spanish" style="font-size:1em; text-align:center;">¿<span>Cuál es</span> la idea principal de la lección de hoy?</p>
                <div class="card__content">
                    <div class="vocab-img">
                        <img src="https://img.freepik.com/free-vector/school-daily-life-cartoon-illustration_1284-26474.jpg?t=st=1724770614~exp=1724774214~hmac=04714c71d8b9176cf72f4c2b6130f40ee74c11106730aa8ff23737c8aa5ec84b&w=740" alt="Classroom">
                    </div>
...
<div id="vocab">
  <table id="vocab-table">
    ...
    <tr>
      <td><img src="https://img.freepik.com/free-vector/teacher-students-wearing-face-mask-class_23-2148691628.jpg?ga=GA1.1.1425892491.1713816127&semt=ais_hybrid" alt="book" /></td>
      <td>¿<span>Puedes darme</span> un ejemplo?</td>
      <td><span>Can you give me</span> an example?</td>
      <td>
        <audio controls>
          <source src="https://www.dropbox.com/scl/fi/q3kwbkk5o000djuwhs0q9/sentence1.mp3?rlkey=oge44e5rzm8jw5238miqkqeca&st=22og7svn&dl=1" type="audio/mpeg" />
          Your browser does not support the audio element.
        </audio>
      </td>
    </tr>
...
<div class="sort-area">
  <div class="labels-to-sort">
    ...
    <div id="word-4" class="label-dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);" style="background-color: rgba(0, 0, 0, 0)">
      <div id="draggable-4" class="draggable-label" ondragstart="onDragStart(event);" draggable="false" style="position: relative; background-color: rgba(0, 0, 0, 0)">ejemplo</div>
    </div>
    <div id="word-5" class="label-dropzone" ondragover="onDragOver(event);" ondrop="onDrop(event);" style="background-color: rgba(0, 0, 0, 0)">
...
function checkAnswer() {
  if (state.lvlIndex == 2) {
    var answer = document.querySelector(`input[name="choice"][value="Aula"]`);
    ...
    if (unanswered == true) {
      ...
      var answers = ["Profesora", "Estudiante", "Libro", "Pizarra"];
      ...
      `;
        ...
        if (studentAns.toLowerCase() == a.toLowerCase()) {
